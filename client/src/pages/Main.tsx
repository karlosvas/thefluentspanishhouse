    ...
    <>
      ...
      <main className="main-index">
        <article className="main-title">
          ...
          <PlaceholderImg src="img/2.webp" className="banner" alt="Banner with inspiring images, sevillana dance">
            <strong>
              Hi, my name is Marta.
              <br /> I’m a Spanish teacher from Spain and I help English speakers become in fluent Spanish. <br />
            </strong>
            <br />
            Before becoming a language teacher, I studied English for many years. <br /> I spent most of my time filling
            in gaps in exercise books, reading, and writing. <br /> After quite a few years, I still struggled to say
            two words in a row, and I felt embarrassed to speak English. <br /> What holds many students back from
            speaking fluently? <br />
            That’s why we have been prioritizing incorrectly for many years. <br /> We use languages to connect with
            others through speech. <br /> So, understanding and mastering basic grammar is our top priority. <br /> If
            you need to change your language learning approach significantly, I can help you.
          </PlaceholderImg>
        </article>
          ...
          <div className="achievements-section">
            ...
            <ul>
              <li>
                ...
                <p>
                  You will improve your understanding and speaking skills through engaging, 100% oral interactive
                  drills. You will master essential Spanish language structures used in 90% of daily conversations.
                </p>
              </li>
              <li>
