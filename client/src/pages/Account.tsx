...
const Account = () => {
  ...
  const handleSVG = (index: number) => {
    ...
    setSvgState((prevState) => prevState.map((state, i) => (i === index ? !state : state)));
          ...
          <div className="ac-content">
            ...
            <section className="ac-info">
              ...
              <ul>
                <li>
                  ...
                  <input
                    ...
                    disabled={!svgState[0]}
                    style={{
                      backgroundColor: svgState[0] ? "transparent" : "rgba(128, 128, 128, 0.5)",
                    }}
                  />
                  <Edit commentText={configUser.displayName} event={handleSVG} index={0} state={svgState[0]} />
                </li>
                <li>
                  Email
                  <input
                    ...
                    disabled={!svgState[1]}
                    style={{
                      backgroundColor: svgState[1] ? "transparent" : "rgba(128, 128, 128, 0.5)",
                    }}
                  />
                  <Edit commentText={configUser.email} event={handleSVG} index={1} state={svgState[1]} />
                </li>
                {/* <li>
              Phone
              <input
              ...
              <div className="action-btn">
                <Button
                  className={`save-user ${
                    user.email === configUser.email && user.displayName === configUser.displayName ? "" : "active"
                  }`}
            ...
            <section className="help-center">
              ...
              <ul>
                <li>
                  ...
                  <a href="#" onClick={() => sendEmailVerificationFirebase(user)}>
                    Click here
                  </a>
                </li>
                <li>
